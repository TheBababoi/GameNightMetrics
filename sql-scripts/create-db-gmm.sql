...
CONSTRAINT fk_players_roles_player_id FOREIGN KEY (user_id) REFERENCES Player(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
CONSTRAINT fk_players_roles_role_id FOREIGN KEY (role_id) REFERENCES Role(id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
